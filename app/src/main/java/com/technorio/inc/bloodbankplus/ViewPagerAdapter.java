...
/**
 * Created by Tenzin on 11/26/2015.
 */
...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    Activity act;
    View layout;
   private TextView pagenumber1,pagenumber2,pagenumber3,pagenumber4,pagenumber5;
  ImageView pageImage;
    Button click;
    public ViewPagerAdapter(Menu mainActivity, int noofsize) {
    ...
    public Object instantiateItem(View container, int position) {
        ...
        try {
            if(pagenumberTxt == 1){
                pageImage.setBackgroundResource(R.drawable.blackb);
                ...
                pageImage.setBackgroundResource(R.drawable.redb);
                ...
                pageImage.setBackgroundResource(R.drawable.whiteb);
                pagenumber1.setTextColor(Color.WHITE);
                pagenumber2.setTextColor(Color.WHITE);
                ...
                pageImage.setBackgroundResource(R.drawable.whiteb2);
                pagenumber1.setTextColor(Color.WHITE);
                pagenumber2.setTextColor(Color.WHITE);
                pagenumber3.setTextColor(Color.WHITE);
                ...
                pageImage.setBackgroundResource(R.drawable.banner);
                pagenumber1.setTextColor(Color.WHITE);
                pagenumber2.setTextColor(Color.WHITE);
                pagenumber3.setTextColor(Color.WHITE);
                pagenumber4.setTextColor(Color.WHITE);
